...
public class Main {
    public static void main(String[] args) {
        ...
        NeuralNetwork t = new NeuralNetwork(nn, "C:\\Users\\Президент\\Desktop\\NeuralNetwork\\src\\simple\\test/test.csv");
        System.out.println(t.counting(dataSet.getTests()[0][0])[0]);
    }
}
